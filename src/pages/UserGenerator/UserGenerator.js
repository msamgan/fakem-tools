...
const UserGenerator = () => {
    ...
    const meta = {
        title: updateTitle("User Generator"),
        description:
            "Generate random user data for testing purposes. This is a free tool that generates random user data.",
        meta: {
            charset: "utf-8",
            name: {
                keywords: "user, generator, random, data, fakem, fake"
            }
        }
    }
